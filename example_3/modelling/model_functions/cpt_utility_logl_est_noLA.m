function [logl, preds] = cpt_ce_logl_est_noLA(x,p,y,q, choice, params)
% x = [-10, -20, 30; 12 15 40];
...
%This section does the certainty equivalence "bugfix" that we now think is
%wrong
...
% xutil
% disp([num2str(params), ',  ', num2str(logl)])
end
